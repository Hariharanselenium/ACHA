...
@Test
@CucumberOptions(
        features = "src/test/resources/features/HealthCareMulti.feature",
        glue = {"com.anhtester.projects.website.HealthcareMulti.stepdefinitions",
                "com.anhtester.hooks"},
...
public class HealthCareTestRunner2 extends AbstractTestNGCucumberTests {
    @Override
